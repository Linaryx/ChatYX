...
export function applySetupImport(
  ...
  if (patch.kickChannel !== undefined) setters.kickChannel(patch.kickChannel);
  ...
  if (patch.overlayBorderWidth !== undefined) setters.overlayBorderWidth(String(patch.overlayBorderWidth));
  if (patch.overlayBorderColor !== undefined) setters.overlayBorderColor(patch.overlayBorderColor);
  if (patch.highlightTwitchEvents !== undefined) setters.highlightTwitchEvents(patch.highlightTwitchEvents);
  if (patch.eventColorOpacity !== undefined) setters.eventColorOpacity(String(patch.eventColorOpacity));
  if (patch.eventColorDefault !== undefined) setters.eventColorDefault(patch.eventColorDefault);
  if (patch.eventColorFirst !== undefined) setters.eventColorFirst(patch.eventColorFirst);
  if (patch.eventColorHighlight !== undefined) setters.eventColorHighlight(patch.eventColorHighlight);
  if (patch.eventColorReward !== undefined) setters.eventColorReward(patch.eventColorReward);
  if (patch.eventColorSubscription !== undefined) setters.eventColorSubscription(patch.eventColorSubscription);
  if (patch.eventColorRaid !== undefined) setters.eventColorRaid(patch.eventColorRaid);
  if (patch.eventColorStreak !== undefined) setters.eventColorStreak(patch.eventColorStreak);
  if (patch.eventColorPowerUp !== undefined) setters.eventColorPowerUp(patch.eventColorPowerUp);
  if (patch.eventColorAnnPrimary !== undefined) setters.eventColorAnnPrimary(patch.eventColorAnnPrimary);
  if (patch.eventColorAnnPurple !== undefined) setters.eventColorAnnPurple(patch.eventColorAnnPurple);
  if (patch.eventColorAnnBlue !== undefined) setters.eventColorAnnBlue(patch.eventColorAnnBlue);
  if (patch.eventColorAnnGreen !== undefined) setters.eventColorAnnGreen(patch.eventColorAnnGreen);
  if (patch.eventColorAnnOrange !== undefined) setters.eventColorAnnOrange(patch.eventColorAnnOrange);
